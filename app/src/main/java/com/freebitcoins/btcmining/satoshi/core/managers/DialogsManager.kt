package com.freebitcoins.btcmining.satoshi.core.managers

import android.support.v4.app.DialogFragment
import android.support.v4.app.FragmentManager
import com.freebitcoins.btcmining.satoshi.screens.dialogs.*
...
class DialogsManager {
    ...
    fun showCurrenciesDialog(fm: FragmentManager, pick: (String) -> Unit) {
        var dialog = CurrenciesDialog(pick)
